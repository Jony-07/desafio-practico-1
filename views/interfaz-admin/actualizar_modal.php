        ...
        <div class="modal-content">
			...
			<div class="form-group row">
				...
				<div class="row form-group">
					...
					<div class="col-md-9">
						<textarea name="desc" id="desc" cols="30" rows="1"><?=$row->descripcion?></textarea>
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-3">
				...
				<div class="row form-group">
					...
					<div class="col-sm-9">
						<input type="text" step="0.1" class="form-control" name="price" id="price" value="<?=$row->precio?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-3">
					...
					<div class="col-sm-9">
						<input type="text" step="0.1" class="form-control" name="existencias" id="existencias" value="<?=$row->existencias?>">
					</div>
				</div>
            </div> 
			</div>
            <div class="modal-footer">
                ...
                <button type="submit" name="add" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Actualizar</button>
				</div>
			</form>
            </div>
