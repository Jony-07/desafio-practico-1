        ...
        <div class="modal-content">
			...
			<form method="POST" action="http://localhost/desafio-practico-1/?c=admin&a=Agregar" enctype="multipart/form-data">
				...
				<div class="row form-group">
					...
					<div class="col-sm-9">
						<input type="text" step="0.1" class="form-control" name="existencias" id="existencias">
					</div>
				</div>
            </div> 
			</div>
            <div class="modal-footer">
                ...
                <button type="submit" name="add" class="btn btn-primary"><span class="glyphicon glyphicon-floppy-disk"></span> Agregar</button>
				</div>
			</form>
